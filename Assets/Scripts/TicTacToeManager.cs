...
public class TicTacToeManager : MonoBehaviour
{
    ...
    [SerializeField] bool P1Comp = false;
    [SerializeField] bool P2Comp = false;
    [SerializeField] float timeBetweenAIMove;

    public enum CompLevel { Simple, Amateur, Intermediate, Difficult }

    [SerializeField] CompLevel compLevel;
    [SerializeField] int[] compDepth;
    ...
    IEnumerator AIMove()
    {
        ...
        if ((P1Comp && turn == 1) || (P2Comp && turn == 2))
        {
            int depth = compDepth[(int)compLevel];
    ...
    void Player1Wins()
    {
        gameStateText.text = "Player One Wins!";
    }

    void Player2Wins()
    {
        gameStateText.text = "Player Two Wins!";
    }
